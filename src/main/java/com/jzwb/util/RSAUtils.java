...
public final class RSAUtils {
    ...
    public static RSAPublicKey getPublicKey(String modulus, String exponent) {
        ...
        try {
            ...
            LOGGER.error("获取公钥错误,参数(modulus:[{}],exponent:[{}])", modulus, exponent, e);
        }
        return null;
    }
    ...
    public static RSAPrivateKey getPrivateKey(String modulus, String exponent) {
        ...
        try {
            ...
            LOGGER.error("获取私钥错误,参数(modulus:[{}],exponent:[{}])", modulus, exponent, e);
        }
        return null;
    }
     ...
     * @return 解密后的数据
     */
    public static String sliceOfDecrypt(PrivateKey privateKey, String text) {
        if (privateKey == null || text == null) {
            return null;
        }
        try {
